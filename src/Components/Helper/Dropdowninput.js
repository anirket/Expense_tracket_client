...
const Dropdowninput = ({ content, index = 10, height, categoryvalue, inputtype }) => {
    ...
    return (
        ...
        <div className="dropdowninput mt-5 bg-gray-500 border-2 text-white border-gray-300 rounded-full  relative w-32 md:w-40  ">
            <button onClick={dropdowntoggle} className="dropdownbuttoninput  font-semibold py-2 px-4 flex justify-around items-center text-sm w-32 md:w-40 focus:outline-none overflow-hidden h-10 whitespace-nowrap overflow-ellipsis">
